...
while True:
    ...
    cookies_click.click()
    cookies_count = eval(driver.find_element(By.ID,"cookies").text.split(" ")[0])
    cursor_clicker = eval(driver.find_element(By.ID,"productPrice0").text)
    buy_cursor =  driver.find_element(By.ID,"product0")
    if cookies_count>=cursor_clicker:
        buy_cursor.click()

    gandma_clicker = eval(driver.find_element(By.ID,"productPrice1").text)
    buy_grandma =  driver.find_element(By.ID,"product1")
    if cookies_count>= gandma_clicker:
        buy_grandma.click()

    try:
        farm_clicker = eval(driver.find_element(By.ID,"productPrice2").text)
    ...
    try:    
        Mine_clicker = eval(driver.find_element(By.ID,"productPrice3").text)
        buy_Mine =  driver.find_element(By.ID,"product3")
    ...
    try:
        Factory_clicker = eval(driver.find_element(By.ID,"productPrice4").text)
        buy_Factory =  driver.find_element(By.ID,"product4")
